...
class ARServer extends StatefulWidget {
  const ARServer({super.key});
  @override
  State<ARServer> createState() => _ARServerState();
}

class _ARServerState extends State<ARServer> {
...
class _BuildRemoveServerTab extends StatefulWidget {
  @override
  _BuildRemoveServerTabState createState() => _BuildRemoveServerTabState();
}
          ...
          Expanded(
            child: StreamBuilder(
              ...
              builder: (context, snapshot) {
                ...
                if (data.isEmpty) {
                  return const Text("There are no servers for the moment...");
                }
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: <Widget>[
            ...
            TextButton(
              onPressed: () {
                // Mark the server as deleted in the database
