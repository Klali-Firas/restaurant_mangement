...
//a Screen that show's a specific order details.
...
//toggle the order status between not ready, ready to serve and served.
  Row changeOrderStatus(String order) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
